...
<hr>
<div class="inner-footer py-6">
    <div class="inner-block mx-6">
        <div class="inner-stack" >
            ...
            <form action="" class="form">
                ...
                <button class="button-bg-fadeout">SUBSCRIBE</button>
            </form>
