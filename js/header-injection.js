...
<div class="container-wrapper">
  <h1 class="banner-label">
    <svg aria-hidden="true" focusable="false" fill="none" width="12" class="icon icon-arrow-left  icon--direction-aware"
    viewBox="0 0 16 18">
  ...
  <h1 class="banner-label">
    <svg aria-hidden="true" focusable="false" fill="none" width="12" class="icon icon-arrow-right  icon--direction-aware"
    viewBox="0 0 16 18">
    ...
    <div class="row">
      <div class="col-sm icon-menu-left">
        <div class="banner-label sidebar-menu-label">
          <button class="btn btn-primary sidebar-toggler" id="sidebar-toggle" type="button"
          data-bs-toggle="offcanvas" data-bs-target="#sidebar-offcanvas" aria-controls="offcanvasDarkNavbar"
        ...
        <div class="banner-label">
          <a href="./index.html">
            ...
            xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <defs>
                <pattern id="pattern0_5_189" patternContentUnits="objectBoundingBox" width="1"
                height="1">
          ...
          <ul class="navigation-list">
            ...
            <li class="bag-icon">
              <a href="cartpage.html">
                <svg aria-hidden="true" fill="none" focusable="false" width="24" class="header__nav-icon icon icon-cart"
                viewBox="0 0 24 24">
...
<div class="sidebar-component offcanvas offcanvas-start" data-bs-scroll="true"
data-bs-backdrop="false" tabindex="-1" id="sidebar-offcanvas" aria-labelledby="offcanvasScrollingLabel">
  <div accordion-button="offcanvas-header" class="offcanvas-header">
    <button id="sidebar-close-btn" type="button" class="btn-close" data-bs-dismiss="offcanvas"
    aria-label="Close">
    </button>
  </div>
  <div class="offcanvas-body">
    <div class="container-side-menu">
      <button id="shop-toggle" class="accordion  btn  btn-primary" type="button"
      data-bs-toggle="offcanvas" data-bs-target="#shop-offcanvas" aria-controls="offcanvasScrolling">
        SHOP
      </button>
    </div>
    <div class="container-side-menu">
    ...
    <div class="container-side-menu">
      <button id="about-toggle" class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
      data-bs-target="#about-offcanvas" aria-controls="offcanvasScrolling">
        ABOUT
      </button>
    </div>
  </div>
...
<div class="sub-menu-component  offcanvas  offcanvas-start" data-bs-scroll="true"
data-bs-backdrop="false" tabindex="-1" id="about-offcanvas" aria-labelledby="offcanvasScrollingLabel">
...
<div class="sub-menu-component  offcanvas  offcanvas-start" data-bs-scroll="true"
data-bs-backdrop="false" tabindex="-1" id="shop-offcanvas" aria-labelledby="offcanvasScrollingLabel">
  <div class="offcanvas-header">
  </div>
  <div class="offcanvas-body">
    <div class="offcanvas-component border-bottom  offcanvas-subheader">
      <div>
        <div class="accordion-item border-bottom mobile" id="shop-section-mobile">
          <h2 class="accordion-header">
            <button
              id="shop-toggle-back"
              class="btn btn-primary"
